...
#Importing the sqllite3 libraries 
...
#initialize the user by creating the table for the users by the necessity columns.
...
# add the users by giving the columns 
...
# fetching the user details by using the username
...
#fetching the user details by using the user id
...
#initlaize the posts by creating the posts
...
# the above code is for adding posts 
...
#the above code is fetching all the posts
...
#the above code is used for fetching all username 
...
#fetching the user posts by using the user id
...
#fetching the id from the users 
...
#the above code is used for adding the comment
...
# the above code is used for the get comments by the user id
...
# the above code is used for the deleting the comment 
