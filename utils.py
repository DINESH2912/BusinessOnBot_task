...
# the above code is used hashing the passwords
...
# the above code us used for checking the password is same while logging in
...
# the above code is used to check is our password is strong or not